...
export class GraphComponent implements OnInit {
  ...
  // Doughnut
  public oldRateChartLabels: string[] = ['<3', '4-6', '>7'];
  public oldRateChartData: number[] = [500, 250, 100];
  public oldRateChartType: string = 'doughnut';

  public newRateChartLabels: string[] = ['<3', '4-6', '>7'];
  public newRateChartData: number[] = [300, 200, 600];
  public newRateChartType: string = 'doughnut';

  //Doughnut Location
  public locationChartLabels: string[] = ['Ontario', 'Quebec', 'British Columbia', 'Manitoba', 'Saskatchewan', 'Nunavut', 'P.E.I', 'New Brunswick'];
